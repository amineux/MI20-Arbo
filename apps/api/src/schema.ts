...
CREATE INDEX IF NOT EXISTS ix_import_raw_err ON import_raw (BatchId, erreur);
CREATE INDEX IF NOT EXISTS ix_import_cmp_batch ON import_compare (BatchId);
CREATE INDEX IF NOT EXISTS ix_import_cmp_batch_new ON import_compare (BatchId, NouveauDocument);
CREATE INDEX IF NOT EXISTS ix_histo_changed ON doc_histo (ChangedAt);
